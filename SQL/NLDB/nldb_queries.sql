...
--ALL QUERIES
	...
	-- Unable to calculate Deaths per enemy type (boss v enemy)
	...
	-- As such, all deaths are attributed to 'Enemies'. Not sure why this is used.
	-- Would not be able to determine ids with suffix 'Enemy' as item, or boss, without making an exhaustive list of one category for filtering
